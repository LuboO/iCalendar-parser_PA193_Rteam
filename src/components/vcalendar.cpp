...
VCalendar VCalendar::parse(const WithPos<GenericComponent> &generic)
{
    ...
    for(const WithPos<GenericComponent> & i : comps) {
        if(i.value().getName().value() == "VEVENT") {
        ...
        } else if (i.value().getName().value() == "VJOURNAL") {
        ...
        } else if (i.value().getName().value() == "VTODO") {
        ...
        } else if (i.value().getName().value() == "VFREEBUSY") {
        ...
        } else if (i.value().getName().value() == "VTIMEZONE") {
