#ifndef ICAL_CORE_GENERICPARSERTEMPLATE_H
#define ICAL_CORE_GENERICPARSERTEMPLATE_H
...
public:
     ...
     */
    template<class InputCharIterator>
    static std::vector<WithPos<GenericComponent>> parseIterators(
...
#endif // ICAL_CORE_GENERICPARSERTEMPLATE_H
